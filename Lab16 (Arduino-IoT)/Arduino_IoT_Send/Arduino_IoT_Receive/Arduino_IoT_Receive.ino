...
const char MQTT_CLIENT_ID[] = "Jerk";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";              // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";              // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "arduino-uno-r4/send";       // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "arduino-uno-r4/sendtopoom";  // CHANGE IT AS YOU DESIRE
...
void messageReceived(String &topic, String &payload) {
  ...
  int txt = payload.toInt();
  int val = map(txt, 0, 1023, 0, 255);
  analogWrite(9, val);
}
